...
## Мета роботи
За допомогою середовища імітаційного програмування розробити систему, що імітує процеси поведінки студентів у їдальні та визначає час очікуваня студентів. Симуляція повинна показати вузькі міста які змушують студентів чекати, та спробувати оптимізувати їх.
